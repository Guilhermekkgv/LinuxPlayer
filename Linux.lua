...
function Linux:Notify(config)
    ...
    local ProgressFill = Linux.Instance("Frame", {
        Parent = ProgressBar,
        BackgroundColor3 = Color3.fromRGB(65, 130, 235),
...
function Linux.Create(config)
    ...
    Linux.Instance("UIListLayout", {
        Parent = TabHolder,
        Padding = UDim.new(0, 4), -- Reduced spacing between tab buttons
    ...
    function LinuxLib.Tab(config)
        ...
        local ContainerListLayout = Linux.Instance("UIListLayout", {
            Parent = Container,
            Padding = UDim.new(0, 5), -- Reduced spacing between elements
            HorizontalAlignment = Enum.HorizontalAlignment.Left,
            SortOrder = Enum.SortOrder.LayoutOrder
        })
        ...
        function TabElements.Button(config)
            ...
            if lastWasDropdown then
                ContainerListLayout.Padding = UDim.new(0, 8) -- Slightly reduced padding after dropdown
            else
                ContainerListLayout.Padding = UDim.new(0, 5) -- Normal padding
            end
            ...
            local originalColor = Color3.fromRGB(25, 25, 32)
            local hoverColor = Color3.fromRGB(30, 30, 40)
            local clickColor = Color3.fromRGB(35, 35, 45)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(65, 130, 235)}):Play()
                        TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 20, 0.5, -7), BackgroundColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                    else
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(30, 30, 40)}):Play()
                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        ...
                        local OptBtn = Linux.Instance("TextButton", {
                            Parent = OptionsHolder,
                            BackgroundColor3 = isSelected and Color3.fromRGB(35, 35, 45) or Color3.fromRGB(30, 30, 40),
                            BorderSizePixel = 0,
                        ...
                        OptBtn.MouseEnter:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(32, 32, 42)}):Play()
                            end
                        end)
                        
                        OptBtn.MouseLeave:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(30, 30, 40)}):Play()
                            end
                        end)
        ...
        function TabElements.Colorpicker(config)
            ...
            local function CreateColorpickerPopup()
                ...
                ApplyButton.MouseLeave:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(35, 35, 45)}):Play()
                end)
