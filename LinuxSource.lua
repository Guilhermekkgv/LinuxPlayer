    ...
    function LinuxLib.Tab(config)
        ...
        if config.Icon and config.Enabled then
            TabIcon = Linux.Instance("ImageLabel", {
                ...
                Image = config.Icon,
                ImageColor3 = Color3.fromRGB(130, 160, 220),
                ZIndex = 2
            })
        end
        ...
        local function SelectTab()
            for _, tab in pairs(Tabs) do
                ...
                tab.Button.BackgroundColor3 = Color3.fromRGB(18, 18, 28)
                tab.Button.BackgroundTransparency = 1
                tab.Indicator.BackgroundTransparency = 1
                
                if tab.Icon then
                    tab.Icon.ImageColor3 = Color3.fromRGB(130, 160, 220)
                end
            end
            ...
            if TabIcon then
                TabIcon.ImageColor3 = Color3.fromRGB(59, 130, 246)
            end
        ...
        function TabElements.Button(config)
            ...
            local originalColor = Color3.fromRGB(18, 18, 28)
            local hoverColor = Color3.fromRGB(28, 28, 38)
            local clickColor = Color3.fromRGB(38, 38, 48)
            ...
            Btn.MouseLeave:Connect(function()
                ...
                TweenService:Create(BtnFrame, tweenInfo, {Size = UDim2.new(1, 0, 0, 34)}):Play()
            end)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(59, 130, 246)}):Play()
                ...
                if IsOpen then
                    for i, opt in pairs(Options) do
                        ...
                        local OptBtn = Linux.Instance("TextButton", {
                            Parent = OptionsHolder,
                            BackgroundColor3 = isSelected and Color3.fromRGB(30, 30, 40) or Color3.fromRGB(22, 22, 32),
                            BorderSizePixel = 0,
                        ...
                        OptBtn.MouseEnter:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(26, 26, 36)}):Play()
                            end
                        end)
                        
                        OptBtn.MouseLeave:Connect(function()
                            if not isSelected then
                                TweenService:Create(OptBtn, tweenInfo, {BackgroundColor3 = Color3.fromRGB(22, 22, 32)}):Play()
                            end
                        end)
        ...
        function TabElements.Slider(config)
            ...
            Linux.Instance("UIGradient", {
                ...
                Color = ColorSequence.new({
                    ...
                    ColorSequenceKeypoint.new(1, Color3.fromRGB(76, 140, 246))
                }),
                Rotation = 90
            })
        ...
        function TabElements.Colorpicker(config)
            ...
            local function CreateColorpickerPopup()
                ...
                ApplyButton.MouseEnter:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(79, 150, 255)}):Play()
                end)
                
                ApplyButton.MouseLeave:Connect(function()
                    TweenService:Create(ApplyButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(59, 130, 246)}):Play()
                end)
